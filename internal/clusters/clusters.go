// WARNING: This file may be autogenerated containing specific cluster
// information for a given Kubernetes environment. Update this file and
// add the corresponding *.crt files to this package to customize, but
// be sure this is not already happening automatically during some CI/CD
// automation.
